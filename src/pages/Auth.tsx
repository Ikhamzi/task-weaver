    ...
    try {
      if (mode === "forgot") {
        ...
        toast({
          ...
          description: `If an account exists for ${email}, we sent a reset link. Google-only accounts won't receive one — sign in with Google instead.`,
        });
        setMode("signin");
        return;
      }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 card-elevated">
          <h1 className="font-display text-2xl font-bold mb-1">
            ...
            {mode === "signup" && "Create your agent"}
            {mode === "forgot" && "Reset your password"}
          </h1>
          <p className="text-muted-foreground text-sm mb-6">
            {mode === "signin" && "Sign in to continue automating."}
            {mode === "signup" && "Start delegating real work to AI."}
